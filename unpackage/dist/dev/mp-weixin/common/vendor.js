...
var showModal = function showModal() {var title = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var content = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  return new Promise(function (resolve, reject) {
    uni.showModal({
      title: title,
      content: content,
...
var showToast = function showToast(_ref) {var title = _ref.title,content = _ref.content;
  return new Promise(function (resolve, reject) {
    uni.showToast({
      title: title,
      content: content,
